...
class Ui_BotAtualizador(object):
    def setupUi(self, BotAtualizador):
        ...
        self.gridLayoutWidget_2.setGeometry(QRect(10, 150, 289, 41))
        ...
        self.gridLayout_2.addWidget(self.confirmar, 0, 2, 1, 1)
    ...
    def retranslateUi(self, BotAtualizador):
        ...
        self.numero_siserps.setPlaceholderText(QCoreApplication.translate("BotAtualizador", u"0", None))
        self.label_3.setText(QCoreApplication.translate("BotAtualizador", u"Numero de Siserps", None))
